...
#for deg in cs16 cs4 cs8 deblur_gauss deblur_uni inp sr2 sr4;
#do
#	echo "*** RUNNING '$deg' TEST ***"
#	python main.py --doc celeba --config imagenet.yml -i imagenet/$deg/s_0.04_n_8 -s 0.04 -n 8 --degradation $deg;
#done
python $@
